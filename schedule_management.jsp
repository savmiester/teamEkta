				...
				<div id = "professorScheduler">
					...
					<label>Select day(s):</label>
						<table>
							...
							<tr>
								<td><input name = "monday" id = "monday" type = "checkbox" value = "0"  disabled></td>
								<td><input name = "tuesday" id = "tuesday" type = "checkbox" value = "1"  disabled></td>
								<td><input name = "wednesday" id = "wednesday" type = "checkbox" value = "2"  disabled></td>
								<td><input name = "thursday" id = "thursday" type = "checkbox" value = "3"  disabled></td>
								<td><input name = "friday" id = "friday" type = "checkbox" value = "4"  disabled></td>
							</tr>
						</table>
